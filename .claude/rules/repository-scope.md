...
Работаем только в `weselow/claude-protocol`. Никаких коммитов, push, PR, комментариев, merge в форк-источник `AvivK5498/The-Claude-Protocol` без явного разрешения пользователя.
